...
export const VINI_ROSSI = [
  ...
  { name: "Blauburgunder Falkestein", regione: "Alto Adige", description: "Pinot Nero in stile altoatesino, fragrante di piccoli frutti rossi, con freschezza alpina e tannino delicato — versatile a tutto pasto." },
  ...
  { name: "Merlo Sanct Valentin San Michele Appiano", regione: "Alto Adige", description: "Merlot della linea Sanct Valentin: ricco, avvolgente, con frutto maturo e legno dolce — al meglio con brasati e formaggi stagionati." },
  ...
  { name: "Lanbrusco Vigna Cà del Fiore Manicardi", regione: "Emilia Romagna", description: "Lambrusco di vigna singola: profumi di ciliegia e viola, spuma fine e sorso asciutto — da provare con tigelle e parmigiano." },
  ...
  { name: "Sforato di Valtellina 5 stelle Nino Negri", regione: "Lombardia", description: "Lo Sforzato simbolo della Valtellina: uve appassite, potenza vellutata e note di frutta sotto spirito — grande vino da meditazione." },
  ...
  // Veneto
  { name: "Amaraone Valpolicella Valpantena Bertani", regione: "Veneto", description: "Amarone della Valpantena: appassimento più snello, frutto elegante e spezie — Bertani in versione contemporanea." },
...
export const SPUMANTI = [
  ...
  { name: "Cuvèe Prestige Cà del Bosco", regione: "Lombardia", description: "La Franciacorta più famosa d'Italia: cremosa, precisa, immancabile — il brindisi che non delude mai." },
  { name: "Cuvèe Prestige conf. 2 bottiglie Cà del Bosco", regione: "Lombardia", description: "Cuvée Prestige in confezione da due: il regalo che fa sempre bella figura." },
  { name: "Cuvèe Prestige conf. 3 bottiglie Cà del Bosco", regione: "Lombardia", description: "Confezione da tre bottiglie: per chi ama regalare, o farsi trovare pronto." },
  { name: "Cuvèe Prestige Jeroboam legno Cà del Bosco", regione: "Lombardia", description: "Jeroboam in cassa di legno: tre litri di Franciacorta per le grandi occasioni — un regalo monumentale." },
  { name: "Cuvèe Prestige magnum Cà del Bosco", regione: "Lombardia", description: "Il Prestige in magnum: perlage ancora più fine, presenza scenica assicurata." },
  ...
  { name: "Franciacorta Gran Cuvèe Bellavista", regione: "Lombardia", description: "La Gran Cuvée di Bellavista: aristocratica, cremosa, festosa — sinonimo di brindisi elegante." },
  { name: "Franciacorta Gran Cuvèe magnum Bellavista", regione: "Lombardia", description: "Bellavista in magnum: eleganza in grande formato." },
  { name: "Franciacorta Gran Cuvèe saten Bellavista", regione: "Lombardia", description: "Il Satèn di Bellavista: morbidezza serica e perlage cremoso." },
  { name: "Franciacorta Gran Cuvèee Rosè Bellavista", regione: "Lombardia", description: "La Gran Cuvée in rosa: Pinot Nero, grazia e piccoli frutti." },
  ...
  { name: "Franciacorta Cuvèe Bellavista", regione: "Lombardia", description: "La cuvée d'ingresso di Bellavista: fresca, floreale, subito felice." },
  // Piemonte
  ...
  { name: "Cuvèe Brut Foss Marai", regione: "Veneto", description: "Cuvée brut fragrante e pulita: pera, fiori e bollicina gentile." },
  { name: "Cuvèe brut Magnum Foss Marai", regione: "Veneto", description: "La cuvée Foss Marai in magnum: brindisi generoso." },
...
export const CHAMPAGNE = [
  ...
  { name: "Blan de Blancs Roederer", regione: "Francia", description: "Blanc de blancs di Roederer: Chardonnay puro, gesso e agrumi — la precisione della grande maison." },
  ...
  { name: "Cuvèe 1522 Philipponat", regione: "Francia", description: "1522, l'anno d'origine della famiglia: cuvée profonda da grandi cru." },
  { name: "Cuvèe Prestige Taittinger", regione: "Francia", description: "Taittinger: Chardonnay in evidenza, grazia e fiori bianchi — brindisi di seta." },
  { name: "Cuvèe Rosè Brut Laurent Perrier", regione: "Francia", description: "Il rosé più famoso di Francia: macerazione vera e frutti rossi vividi — un classico assoluto." },
  ...
  { name: "Enoteque 1996 Dom Perignon", regione: "Francia", description: "Dom Pérignon Oenothèque 1996: sboccatura tardiva di un'annata mitica — collezionismo puro." },
  ...
  { name: "Cuveè Royal Joseph Perrier", regione: "Francia", description: "Joseph Perrier, maison storica di Châlons: morbida e fruttata — fu lo Champagne della regina Vittoria." },
  { name: "La Grande Dame Veuve Cliquot Ponsardin", regione: "Francia", description: "La cuvée dedicata a Madame Clicquot: potenza vellutata dai grandi cru di Pinot Nero." },
  { name: "Cristal Millesimato 2004 Roeder", regione: "Francia", description: "Cristal 2004: nato per uno zar, preciso come un diamante — il mito di Roederer." },
  { name: "Millesimè 2002 Laurent Perrier", regione: "Francia", description: "Millesimato 2002: un'annata di riferimento, evoluzione elegante." },
  { name: "Riserva San Pietroburgo Veuve Cliquot Ponsardin", regione: "Francia", description: "Riserva che omaggia la corte russa innamorata della Veuve: ricca e cerimoniale." },
  { name: "Rosè Veuve Cliquot Ponsardin", regione: "Francia", description: "Il rosé della Veuve: fragole, brio e riconoscibilità assoluta." },
  ...
  { name: "Special Cuvèe Bollinger", regione: "Francia", description: "Bollinger: vinificazione in legno, ampiezza e carattere — lo Champagne di James Bond." },
  ...
  { name: "Vintage 2002 Veuve Cliquot Ponsardin", regione: "Francia", description: "Millesimato 2002 della Veuve: struttura e maturità nobile." },
...
export const VINI_DOLCI = [
  ...
  // Austria
  { name: "Auslese Cuvèe Kracher", regione: "Austria", description: "Kracher, il maestro austriaco dei vini dolci: Auslese armoniosa tra miele e frutta gialla." },
  ...
  { name: "Saternes Grand Cru Classè Chateau de Malle", regione: "Francia", description: "Sauternes di castello classificato: botrytis, miele e zafferano — dolcezza nobile bordolese." },
  { name: "Sauernes Les Justices Chateau Les Justices", regione: "Francia", description: "Sauternes generoso e fine: albicocca, miele e freschezza — con foie gras e formaggi blu." },
  ...
  { name: "Sauternes ml.375 Chateau Simons", regione: "Francia", description: "Mezza bottiglia di Sauternes: dolcezza giusta per due." },
  ...
  { name: "Sauternes Mouton Cadet Philipe de Rothschild", regione: "Francia", description: "Il Sauternes della casa Rothschild: accessibile e ben fatto." },
